...
class ContactData extends Component {
  ...
  changedFormHandler(event,inputIdentifier){
    ...
    let form = (
      <form onSubmit={this.orderHandler}>
        {formElementsArray.map(formElement => (
          ...
          changed={(event) => this.changedFormHandler(event,formElement.id)}/>
        ))}
...
export default connect(mapsStateToProps,mapsDispatchtoProps)(withErrorHandler(ContactData, axios));
